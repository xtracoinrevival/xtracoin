...
HEADERS += src/qt/xtracoingui.h \
    ...
    src/qt/xtracoinaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/xtracoin.cpp \ 
    ...
    src/qt/xtracoinaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/xtracoinstrings.cpp \
    src/qt/xtracoinamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
TRANSLATIONS = $$files(src/qt/locale/xtracoin_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/xtracoin-qt.rc src/test/*.cpp src/test/*.h src/qt/test/*.cpp src/qt/test/*.h
...
windows:RC_FILE = src/qt/res/xtracoin-qt.rc
...
macx:ICON = src/qt/res/icons/xtracoin.icns
macx:TARGET = "xtracoin-Qt"
