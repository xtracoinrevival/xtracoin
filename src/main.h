...
static const int64 MAX_MONEY = 50000000 * COIN; //total of 50 million coins (incl. PoS)
static const int64 MAX_MINT_PROOF_OF_WORK = 500 * COIN;	
static const int64 MAX_MINT_PROOF_OF_STAKE = .23 * MAX_MINT_PROOF_OF_WORK;	//23% annual stake
static const int64 NEW_MAX_MINT_PROOF_OF_STAKE = .60 * COIN;	//60% annual stake ( 5% monthly)
...
static const uint256 hashGenesisBlockOfficial("0x0000062ed97b3e5faa555f357bc3aa732c00bc8fb908632f1d16dc4d33c449f4");
...
public:
    ...
    */
    ...
    /** Amount of xtracoins spent by this transaction.
    ...
    /** Amount of xtracoins coming in to this transaction
...
public:
    ...
    {
        // Protocol switch to support p2pool at xtracoin block #9689
        ...
        // Before xtracoin block #9689 - old protocol
